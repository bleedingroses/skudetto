    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Skudetto</p>
        </div>
    </div>
    <!-- ============================================================== -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                ...
                                                <div class="mail-contnet">
                                                    <h5>Redo Almy</h5> <span class="mail-desc">Just see the my admin!</span> <span class="time">9:30 AM</span> </div>
                                            </a>
                                        </div>
                                    </li>
                                    <li>
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="flag-icon flag-icon-id"></i></a>
                            <div class="dropdown-menu dropdown-menu-right animated bounceInDown"> <a class="dropdown-item" href="#"><i class="flag-icon flag-icon-id"></i>Indonesia</a> </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- Profile -->
                        <!-- ============================================================== -->
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li>
                                    ...
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="/member/6/divisi">Daftar Anggota</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="has-arrow " href="#" aria-expanded="false">Kiyosi Malang</a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="/member/7/divisi">Daftar Anggota</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="has-arrow " href="#" aria-expanded="false">Perlengkapan Malang</a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="/member/8/divisi">Daftar Anggota</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="has-arrow " href="#" aria-expanded="false">Perlengkapan Surabaya</a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="/member/9/divisi/">Daftar Anggota</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a class="has-arrow" href="#" aria-expanded="false">Supporting Paniai</a>
                                    <ul aria-expanded="false" class="collapse">
                                        <li><a href="/member/10/divisi">Daftar Anggota</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </li>
